...
export class Migration20210819143130 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "nba_game_data" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "away_team_id" int4 not null, "home_team_id" int4 not null, "event_information_id" int4 not null, "league" varchar(255) not null, "away_period_scores" text[] not null, "home_period_scores" text[] not null, "away_totals_id" int4 not null, "home_totals_id" int4 not null);');
